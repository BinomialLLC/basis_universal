...
namespace basisu
{
	...
	typedef basisu::MVector<encoder_block> encoder_block_vec;
	...
	typedef basisu::MVector<etc1_endpoint_palette_entry> etc1_endpoint_palette_entry_vec;
	...
	typedef basisu::MVector<basisu_backend_slice_desc> basisu_backend_slice_desc_vec;
	...
	struct basisu_backend_output
	{
		...
		basisu::MVector<uint8_vec> m_slice_image_data;
	...
	private:
		...
		typedef basisu::MVector<etc1_global_selector_cb_entry_desc> etc1_global_selector_cb_entry_desc_vec;

		etc1_global_selector_cb_entry_desc_vec m_global_selector_palette_desc;

		basisu::MVector<encoder_block_vec2D> m_slice_encoder_blocks;
