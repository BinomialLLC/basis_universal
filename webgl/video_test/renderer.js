...
Renderer.prototype.updateCompressedTexture = function(texture, data, width, height, format) {
  var gl = this.gl_;

  // Bind the existing texture
  gl.bindTexture(gl.TEXTURE_2D, texture);

  // Update the compressed texture with new data
  gl.compressedTexSubImage2D(
    ...
    format,        // internal format of the compressed texture
    data           // new data
  );
...
Renderer.prototype.updateRgb565Texture = function(texture, rgb565Data, width, height) {
  var gl = this.gl_;

  // Bind the existing texture
  gl.bindTexture(gl.TEXTURE_2D, texture);

  // Update the texture with new uncompressed data
  gl.texSubImage2D(
    gl.TEXTURE_2D,              // target
    0,                          // level of detail (0 is base image level)
    0,                          // x offset
    ...
    width,                      // width of the texture
    height,                     // height of the texture
    gl.RGB,                     // format of the texture
    gl.UNSIGNED_SHORT_5_6_5,    // data type of the texture data
    rgb565Data                  // new data
  );
