# For this fork
Add some feature so that you can integrate it in your pipeline, I have made it work in Unreal Engine and Unity. Here is the new feature.
- Support for outer mipmaps, which means that you can use the mipmap generated by game engine
- Support self defined memory allocator, if you want to integrate it to the game engine, you may want the engine to take over memory allocation
