...
namespace lodepng {
#ifdef LODEPNG_COMPILE_DECODER
/*Same as lodepng_decode_memory, but decodes to an basisu::MVector. The colortype
is the format to output the pixels to. Default is RGBA 8-bit per channel.*/
unsigned decode(basisu::MVector<unsigned char>& out, unsigned& w, unsigned& h,
                const unsigned char* in, size_t insize,
                LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
unsigned decode(basisu::MVector<unsigned char>& out, unsigned& w, unsigned& h,
                const basisu::MVector<unsigned char>& in,
                LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
#ifdef LODEPNG_COMPILE_DISK
/*
...
#ifdef LODEPNG_COMPILE_ENCODER
/*Same as lodepng_encode_memory, but encodes to an basisu::MVector. colortype
is that of the raw input data. The output PNG color type will be auto chosen.*/
unsigned encode(basisu::MVector<unsigned char>& out,
                const unsigned char* in, unsigned w, unsigned h,
                LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
unsigned encode(basisu::MVector<unsigned char>& out,
                const basisu::MVector<unsigned char>& in, unsigned w, unsigned h,
                LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
#ifdef LODEPNG_COMPILE_DISK
/*
...
#ifdef LODEPNG_COMPILE_CPP
/* The LodePNG C++ wrapper uses basisu::MVectors instead of manually allocated memory buffers. */
namespace lodepng {
#ifdef LODEPNG_COMPILE_PNG
...
#ifdef LODEPNG_COMPILE_DISK
/*
Load a file from disk into an basisu::MVector.
return value: error code (0 means ok)
*/
unsigned load_file(basisu::MVector<unsigned char>& buffer, const std::string& filename);

/*
Save the binary data in an basisu::MVector to a file on disk. The file is overwritten
without warning.
*/
unsigned save_file(const basisu::MVector<unsigned char>& buffer, const std::string& filename);
#endif /* LODEPNG_COMPILE_DISK */
#endif /* LODEPNG_COMPILE_PNG */
...
unsigned decompress(basisu::MVector<unsigned char>& out, const unsigned char* in, size_t insize,
                    const LodePNGDecompressSettings& settings = lodepng_default_decompress_settings);

/* Zlib-decompress an basisu::MVector */
unsigned decompress(basisu::MVector<unsigned char>& out, const basisu::MVector<unsigned char>& in,
                    const LodePNGDecompressSettings& settings = lodepng_default_decompress_settings);
#endif /* LODEPNG_COMPILE_DECODER */

#ifdef LODEPNG_COMPILE_ENCODER
/* Zlib-compress an unsigned char buffer */
unsigned compress(basisu::MVector<unsigned char>& out, const unsigned char* in, size_t insize,
                  const LodePNGCompressSettings& settings = lodepng_default_compress_settings);

/* Zlib-compress an basisu::MVector */
unsigned compress(basisu::MVector<unsigned char>& out, const basisu::MVector<unsigned char>& in,
                  const LodePNGCompressSettings& settings = lodepng_default_compress_settings);
#endif /* LODEPNG_COMPILE_ENCODER */
#endif /* LODEPNG_COMPILE_ZLIB */
} /* namespace lodepng */
...
The C++ version has extra functions with basisu::MVectors in the interface and the
...
basisu::MVectors and std::strings in C++ can be incompatible.
...
int main(int argc, char *argv[]) {
  ...
  //load and decode
  basisu::MVector<unsigned char> image;
...
*) 04 jun 2007: improved support for Visual Studio 2005: crash with accessing
    invalid basisu::MVector element [0] fixed, and level 3 and 4 warnings removed
...
*) 07 sep 2005: (!) Changed to basisu::MVector interface
