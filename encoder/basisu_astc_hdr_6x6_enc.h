...
namespace astc_6x6_hdr
{
	...
	struct astc_hdr_6x6_global_config
	{
		...
		// This encoder computes colorspace error in the ICtCp (or more accurately the delta E ITP, where CT is scaled by .5 vs. ICtCp to become CT) colorspace, so getting this correct is important.
